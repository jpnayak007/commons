...
public enum RegistrationCenterMachineErrorCode {
	...
	REGISTRATION_CENTER_MACHINE_FETCH_EXCEPTION("KER-MSD-601","Error occurred while fetching Center Machine details"),REGISTRATION_CENTER_MACHINE_ZONE_INVALID("KER-MSD-411","Admin not authorized to map/un-map this Registration Center or Machine"),
